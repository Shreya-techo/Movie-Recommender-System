...
def load_data():
    ...
    movie_embedding = pickle.load(open("models/movie_embedding.pkl", "rb"))
    movies_semantic = pickle.load(open("models/movies_semantic.pkl", "rb"))
...
with tab1:
    ...
    st.header("Find movies similar to your favorite movie")
...
with tab2:
    ...
    st.header("Semantic movie using natural language")
    ...
    with st.container(border=True):
        ...
        st.caption(
            "Examples: space adventure, mother-child relationship, alien invasion, time travel, astronaut"
        )
